...
//		_ReceivedShadowsStrength ("Received Shadows Strength", Range(0,1)) = 0.5
	...
	Category
	{
		...
		CGINCLUDE
			...
			#if CFXR_URP
				//#include "JMO Assets\Cartoon FX Remaster\CFXR Assets\Shaders\CFXR_URP.cginc"
			#else
			...
			//#include "JMO Assets\Cartoon FX Remaster\CFXR Assets\Shaders\CFXR_SETTINGS.cginc"
